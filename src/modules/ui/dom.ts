...
import { createPiPButton, isPiPSupported } from "./pictureInPicture";
...
function createFooter(
  ...
  try {
    ...
    if (isPiPSupported()) {
      ...
      pipContainer.className = `${FOOTER_CLASS}__container`;
      pipContainer.appendChild(createPiPButton());
      footer.appendChild(pipContainer);
    }
